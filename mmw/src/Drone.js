  ...
  return (
    <div className="drone">
      ...
      <div className="content">
        ...
        <section id="services">
          <h1 className="title">Welcome to <span className="highlight">Monaco Media Works</span>!</h1>
          <h3 className="description">
            At <span className="highlight">Monaco Media Works</span>, we specialize in providing cutting-edge aerial photography and videography services tailored to meet your unique needs. With our state-of-the-art FPV drones and expert team, we offer a range of services to enhance your brand's visual storytelling.
          </h3>
